...
<!--		<?php $_from = $this->_tpl_vars['pom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['node']):
?>
		<div class="prod">
		<a href="<?php echo $this->_tpl_vars['node']->pom_link; ?>
"<?php if ($this->_tpl_vars['node']->pom_new_window): ?> target="_blank"<?php endif; ?>>
			<img src="/source/images/product_on_main/<?php echo $this->_tpl_vars['node']->image; ?>
" alt="" />
		</a>
		<br /><a href="<?php echo $this->_tpl_vars['node']->pom_link; ?>
"<?php if ($this->_tpl_vars['node']->pom_new_window): ?> target="_blank"<?php endif; ?>><?php echo $this->_tpl_vars['node']->pom_name; ?>
</a></div>
		<?php endforeach; endif; unset($_from); ?>
		
			<div class="about_alw">
				<img class="h" src="/source/images/about-alw.jpg" alt="" />
				<p class="text" style="line-height: 20px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['about']->pages_content)) ? $this->_run_mod_handler('truncate', true, $_tmp, 150) : smarty_modifier_truncate($_tmp, 150)); ?>
</p><br />
