...
require_once $_SERVER['DOCUMENT_ROOT'].'/system/application/libraries/PEAR.php';
require_once $_SERVER['DOCUMENT_ROOT'].'/system/application/libraries/Spreadsheet/excel/Writer/Workbook.php';
