...
{literal}
	$(document).ready(function() {
		...
		$( "#draggable" ).draggable( "option", "cursor", "pointer");
		 ...
		 $('.closeBtn').click(function (e) {  
			...
			if ($('.pimp1').attr("class").indexOf('active') > 0) {
				$('.pimp1').stop().animate({width:"54px",height:"46px",top:"212px"}, 400);
				$('.pimp1').attr("src","/source/images/pimp.png");
				$('.pimp1').removeClass('active');
			}
			if ($('.pimp2').attr("class").indexOf('active') > 0) {
				$('.pimp2').stop().animate({width:"54px",height:"46px",top:"181px"}, 400);
		...
		$('.pimp1').stop().animate({width:"83px",height:"71px",top:"187px"}, 400);
		$('.pimp1').attr("src", "/source/images/pimpBig.png");
		$('.pimp1').addClass('active');
		$('.dragWindow').offset({ top: 160, left: $('.pimp1').offset().left+35 });
	});
...
$(function(){
	$('.pimp1').hover(function(){
			$(this).stop().animate({width:"83px",height:"71px",top:"187px"}, 400);
			$(this).attr("src","/source/images/pimpBig.png");
		},
		function(){
			if ($(this).attr("class").indexOf('active') == -1) {
				$(this).stop().animate({width:"54px",height:"46px",top:"212px"}, 400);
				$(this).attr("src","/source/images/pimp.png");
			}
		});
	$('.pimp2').hover(function(){
			$(this).stop().animate({width:"83px",height:"71px",top:"156px"}, 400);
			$(this).attr("src","/source/images/pimpBig.png");
		},
		function(){
			if ($(this).attr("class").indexOf('active') == -1) {
				$(this).stop().animate({width:"54px",height:"46px",top:"181px"}, 400);
				$(this).attr("src","/source/images/pimp.png");
			}
		});
	...
	$('.pimp2').click(function() {
		...
		if ($('.pimp1').attr("class").indexOf('active') > 0) {
			$('.pimp1').removeClass('active');
			$('.pimp1').stop().animate({width:"54px",height:"46px",top:"224px"}, 400);
			$('.pimp1').attr("src","/source/images/pimp.png");
		}
