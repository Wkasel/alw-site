...
<table cellpadding="0" cellspacing="0" class="inline">
	...
	<tr style="background-color: #{if $smarty.foreach.rows_list.iteration%2}FFF{else}f8f8f8{/if};">
		<td>
			...
			<a href="/{$my_mode}/index/{$alias_talbe}/delete_item/{$row->table_id}/{$current}/" onclick="javascript:return delItem({$row->table_id});"><img width="20" height="20" alt="Delete" src="/source/images/admin/del.gif"/></a>
