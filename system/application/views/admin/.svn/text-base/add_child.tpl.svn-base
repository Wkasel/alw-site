	...
	{if $field.type neq 'expression' && $field.type neq 'id'}
		<tr>
			{if $field.type eq 'input'}
				<td>{$field.value}</td>
				<td><input type="text" value="{$filled.$key}" class="fields" name="_child__{$table}__{$key}[]" {if $field.disabled}DISABLED{/if} {if isset($field.style)}style="{$field.style}"{/if} /></td>
			{/if}
			{if $field.type eq 'password'}
				<td>{$field.value}</td>
				<td><input type="password" value="{$filled.$key}" class="fields" name="_child__{$table}__{$key}[]" {if $field.disabled}DISABLED{/if} {if isset($field.style)}style="{$field.style}"{/if} /></td>
			{/if}
			{if $field.type eq 'textarea'}
				<td>{$field.value}</td>
				<td><textarea name="_child__{$table}__{$key}[]" class="fields" {if $field.disabled}DISABLED{/if} {if isset($field.style)}style="{$field.style}"{/if}>{$filled.$key}</textarea></td>
			{/if}
			...
			{if $field.type eq 'checkbox'}
				<td>{$field.value}</td>
				<td><input type="hidden" name="_child__{$table}__{$key}[]" value="off" /><input type="checkbox" name="_child__{$table}__{$key}[]" class="fields" {if $field.disabled}DISABLED{/if} {if isset($field.style)}style="{$field.style}"{/if} {if $validate}{if $filled.$key eq 'on'}checked="checked"{/if}{else}{if $field.checked}checked="checked"{/if}{/if} /></td>
			{/if}
			{if $field.type eq 'select' && $field.from.mode eq 'from_table'}
				<td>{$field.value}</td>
				<td>
					<select class="fields" name="_child__{$table}__{$key}[]" {if isset($field.style)}style="{$field.style}"{/if}>
			...
			{if $field.type eq 'image' || $field.type eq 'file'}
				<td>{$field.value}</td>
				<td><input class="fields" type="file" name="_child__{$table}__{$key}[]" {if isset($field.style)}style="{$field.style}"{/if} /></td>
			{/if}
			{if $field.type eq 'radio'}
				<td>{$field.value}</td>
				<td>
				{foreach from=$field.alias key=radio_key item=radio_sec}
				<input class="fields" type="radio" name="_child__{$table}{$key}[]" value="{$radio_key}" {if $field.disabled}DISABLED{/if} {if isset($field.style)}style="{$field.style}"{/if} {if $validate}{if $filled.$key eq $radio_key}checked="checked"{/if}{else}{if $field.checked eq $radio_key}checked="checked"{/if}{/if} />{$radio_sec}
				{/foreach}
				</td>
			{/if}
			{if $field.type eq 'date'}
				<td>{$field.value}</td>
				<td>
				<input class="fields" type="text" name="_child__{$table}__{$key}[]" value="{$filled.$key}" id="{$key}" /><button type="reset" id="{$key}_button">...</button>
				{literal}
				<script type="text/javascript">
				    Calendar.setup({
