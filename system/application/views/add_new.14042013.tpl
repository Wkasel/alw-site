							...
							<div class="add_new_project">
								...
								<div class="attach">
									...
									<div class="file clearfix">
											...
											<a href="/source/files/main_files/{$node->file}">{$node->file}</a> <a onclick = "return confirm('Do you really want to delete it?')" href="/area/delete_attachment/{$new_id}/{$node->id}/add_new/"><img src="/source/images/delete-icon.png" alt="" /></a></div>
