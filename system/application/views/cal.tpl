...
<div class="rep_content_page clearfix"> <!-- rep content page -->
    ...
    <p>* All prices calculated at 15% commissionable pricing.  Consult factory for alternatives/commission structure</p>
    <p>** Volume pricing available </p>
			<form name="form1" class="dsR80 dsR778">
                ...
                <input type="button" onclick="goOut();" value="Go"><br>
							</form>
		</div>
