					...
					<div class="inner">
						<div class="in-inner clearfix">
							<div class="nav clearfix"> <!-- navigation -->
								<ul {if $user_info} style="width:680px;" {/if}class="clearfix {if $user_info}loginUl{/if}">
									<li class="prod">
										...
										<ul>
											...
											<li><a href="/content/pages/bim_rev/" >BIM/Photometry Downloads</a></li>
										</ul>
									</li>
									...
									*}<li>
										...
										<tr>
										<td nowrap><div style="margin-right:3px;margin-top:2px; background-color:#990000;"><a href="http://visitor.r20.constantcontact.com/d.jsp?llr=5kw8jddab&p=oi&m=1102843861342"  target="_blank"><!--<img src="https://imgssl.constantcontact.com/ui/images1/visitor/email3_trans.gif" border="0">--></a></div></td>
										<td nowrap width="100%"><a href="http://visitor.r20.constantcontact.com/d.jsp?llr=5kw8jddab&p=oi&m=1102843861342"  target="_blank">JOIN OUR MAILING LIST</a></td>
										</tr>
										</table>
										</div>
										<!-- END: Constant Contact Text Link Email List Button -->
									</li>																			<li><a href="/content/event_calendar/"{if $section == 'event_calendar'} class="active"{/if}>EVENT CALENDAR</a></li>									
								</ul>
								{if !$user_info}
